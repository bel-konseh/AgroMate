...
import { Plus } from 'lucide-react'; // Changed back to Plus for Add Product
...
const FarmerDashboardPage: React.FC = () => {
  ...
  const productCount = products.length; // Count now refers to products/goods sold 
  const balance = 0; 
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:space-x-6 space-y-6 lg:space-y-0">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 lg:w-1/3 flex flex-col items-center border border-gray-100">
                <p className="text-sm text-gray-500 mb-4">Goods Sold</p> {/* CORRECTED LABEL */}
                ...
                {products.map((product) => (
                  <tr key={product.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-900">Huckleberry || Njama Njama</span>
                    </td>
